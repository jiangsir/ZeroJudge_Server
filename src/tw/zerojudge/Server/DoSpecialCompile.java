...
public class DoSpecialCompile {
	...
	public void run() throws JudgeException {
		...
		new RunCommand("").start("sudo " + serverConfig.getBinPath() + File.separator
				+ "DoSpecialCompile.py " + serverConfig.getTempPath() + File.separator
		...
		// "/rootfs/";
		// 20181205 doSpecialCompile 取消 -u nobody
		// 20190409 取消 sudo
		String lxc_attach = serverConfig.getLxc_EXEC() + " -- sudo -u nobody ";
		cmd_compile = lxc_attach + serverConfig.getBinPath() + File.separator + "shell.exe "
				+ "10 640000000 100000000 \"" + serverConfig.getBinPath() + File.separator
