...
public class EditServerConfigServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		serverConfig.setLxc_EXEC(request.getParameter("Lxc_EXEC"));
		serverConfig.setLxc_PATH(request.getParameter("Lxc_PATH"));
		...
		serverConfig.setIsTLEbreak(request.getParameter("isTLEbreak"));
