...
int main(int argc, char *argv[])
{
    ...
    double exectime = usage.ru_utime.tv_sec + usage.ru_stime.tv_sec + (double)(usage.ru_utime.tv_usec + usage.ru_stime.tv_usec) / 1000000;
    double basetime = baseusage.ru_utime.tv_sec + baseusage.ru_stime.tv_sec + (double)(baseusage.ru_utime.tv_usec + baseusage.ru_stime.tv_usec) / 1000000;
