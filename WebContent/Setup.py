...
os.system('sudo gcc /JudgeServer_CONSOLE/Bin/base_c.c -o /JudgeServer_CONSOLE/Bin/base_c.exe')
os.system('sudo g++ -o /JudgeServer_CONSOLE/Bin/base_cpp.exe /JudgeServer_CONSOLE/Bin/base_cpp.cpp')
