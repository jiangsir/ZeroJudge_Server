		...
		<form name="form1" method="post" action="">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="serverconfig">
					...
					<div class="form-group">
						<label for="" class="col-sm-2 control-label">遇到 TLE 是否中斷?： </label>
						<div class="col-sm-10">
							<input name="isTLEbreak" type="radio" value="true"
								isTLEbreak="${serverConfig.isTLEbreak}" /> 是 (遇TLE中斷，練習環境) <input
								name="isTLEbreak" type="radio" value="false"
								isTLEbreak="${serverConfig.isTLEbreak}" /> 否 (完全評分，競賽使用)？<br />
							<p class="help-block"></p>
						</div>
					</div>
					<%--
